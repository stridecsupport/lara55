...
var itemtype=0;
  ...
  function additems()

	{
		...
		var rows="<tr id='row_"+cnt+"'><td><input type='hidden' name='input_type[]' value='1'/><input type='checkbox' onclick=boxDisable('items',"+cnt+",$(this),'0'); value='1' name='product_check_1[]'/></td><td><select name='productid_1[]' onchange=getproductdetails("+itemtype+","+cnt+",this.value); required><option value='0'>Select Items</option>@foreach($products as $productss)<option value='{{$productss->id}}'>{{$productss->name}}</option>@endforeach</select></td><td><input type='text' id='description"+cnt+"' name='product_description[]' required></td><td><input type='number' id='quantity"+cnt+"' oninput=onchangequantity('"+cnt+"'); name='quantity_1[]' required/></td><td><input type='text' id='cost_price"+cnt+"' oninput=onchangecostprice('"+cnt+"'); name='cost_price_1[]' required/></td><td><input type='text' name='unit_price_1[]' oninput=onchangecalcalculation('"+cnt+"'); id='unit_price"+cnt+"' required/></td><td><input type='text' name='percentage_1[]' id='product_percentage"+cnt+"' readonly required/></td><td><input id='margin_cost"+cnt+"' type='text' name='margin_1[]' readonly required/></td><td><input type='text' name='amount_1[]' id='product_amount"+cnt+"' readonly required/></td><td><button onclick='deleterow("+cnt+");'>Delete</button></td></tr>";
	...
	function addsectionitems(rowcount,sectioncount)
	{
		...
		var rows="<tr id='row_"+cnt+"'><td><input type='hidden' name='input_type[]' value='3'/><input type='checkbox' onclick=boxDisable('sections',"+cnt+",$(this),"+sectioncount+"); value='1' name='product_check_3[]'/></td><td><select name='productid_3[]' onchange='getproductdetails("+sectioncount+","+cnt+",this.value);' required><option value='0'>Select Items</option>@foreach($products as $productss)<option value='{{$productss->id}}'>{{$productss->name}}</option>@endforeach</select></td><td><input type='text' id='description"+cnt+"' name='product_description[]' required></td><td><input type='number' id='quantity"+cnt+"' oninput='onchangequantity('"+cnt+"');' name='quantity_3[]' required/></td><td><input type='text' id='cost_price"+cnt+"' oninput='onchangecostprice('"+cnt+"');' name='cost_price_3[]' required/></td><td><input type='text' name='unit_price_3[]' oninput='onchangecalcalculation('"+cnt+"');' id='unit_price"+cnt+"' required/></td><td><input type='text' name='percentage_3[]' id='product_percentage"+cnt+"' readonly required/></td><td><input id='margin_cost"+cnt+"' type='text' name='margin_3[]' readonly required/></td><td><input type='text' name='amount_3[]' id='product_amount"+cnt+"' readonly required/></td><td><button onclick='deleterow("+cnt+");'>Delete</button></td></tr>";
...
function grandtotalcalculation()
	{
		finalamount=0;
		finalamount1=0;
		$('input[name="amount_1[]"]').each(function() {
        ...
        $('input[name="amount_3[]"]').each(function() {
        var i = parseInt($(this).val());
        if (!isNaN(i))
		  {
			finalamount1 += i;
        ...
        var total=finalamount+finalamount1;
...
function sectionsubtotalcalculation(count)
	{
		...
		$('#sectionbody'+count+' input[name="amount_1[]"]').each(function() {
		...
		$('#sectionbody'+count+' input[name="quantity_1[]"]').each(function() {
		...
		$('#sectionbody'+count+' input[name="unit_price_1[]"]').each(function() {
		...
		$('#sectionbody'+count+' input[name="cost_price_1[]"]').each(function() {
		...
		$('#sectionbody'+count+' input[name="margin_3[]"]').each(function() {
        ...
        $('#sectionbody'+count+' input[name="amount_3[]"]').each(function() {
        var a = parseInt($(this).val());
        if (!isNaN(a))
		  {
			finalamount1 += a;
		...
		$('#sectionbody'+count+' input[name="quantity_3[]"]').each(function() {
        var q = parseInt($(this).val());
        if (!isNaN(q))
		  {
			finalquantity1 += q;
		...
		$('#sectionbody'+count+' input[name="unit_price_3[]"]').each(function() {
        var u = parseInt($(this).val());
        if (!isNaN(u))
		  {
			finalunitprice1 += u;
		...
		$('#sectionbody'+count+' input[name="cost_price_3[]"]').each(function() {
        var c = parseInt($(this).val());
        if (!isNaN(c))
		  {
			finalcostprice1 += c;
	    ...
	    document.getElementById('subtotal_subamount'+count).value=finalamount+finalamount1;
		document.getElementById('subtotal_qty'+count).value=finalquantity+finalquantity1;
		document.getElementById('subtotal_costprice'+count).value=finalcostprice+finalcostprice1;
		document.getElementById('subtotal_unitprice'+count).value=finalunitprice+finalunitprice1;
		document.getElementById('subtotal_margin'+count).value=finalmarginprice+finalmarginprice1;
